export default {
  ...
  display_mode: "显示模式",
  show_in: "显示于",
  display_mode_both: "页面和画布",
  display_mode_edgeless: "仅画布",
  display_mode_page: "仅页面",
  turn_into: "转换为",
  open_doc: "打开文档",
  reload: "重新加载",
  updated: "已更新",
  ...
  open: "打开",
  open_doc_menu: "打开文档菜单",
  open_doc_with: "使用以下方式打开文档",
  scale: "缩放",
  press_for_commands: "按'/'使用命令",
  in_both: "页面和画布",
  in_page_only: "仅页面",
  in_edgeless_only: "仅画布",
  fill_color: "填充颜色",
  border_color: "边框颜色",
  Untitled: "无标题",
  edit: "编辑",
  ...
  doc_preview_placeholder: "文档预览将在此显示。",
  synced_doc_placeholder: "这是一个链接文档，您可以在此添加内容。",
  new_doc: "新建文档",
  export_markdown: "导出 Markdown",
  export_html: "导出 HTML",
  export_plain_text: "导出纯文本",
  export_pdf: "导出 PDF",
  export_png: "导出 PNG",
  export_snapshot: "导出快照",
  import_snapshot: "导入快照",
  import_notion_html: "导入 Notion HTML",
  single_notion_html_page: "单页 Notion HTML",
  notion_html_zip: "Notion HTML 压缩包",
  import_markdown: "导入 Markdown",
  markdown_files: "Markdown 文件",
  markdown_zip: "Markdown 压缩包",
  import_html: "导入 HTML",
  html_files: "HTML 文件",
  html_zip: "HTML 压缩包",
  import_html_success: "成功导入 {count} 个 HTML 文件。",
  import_html_failed: "导入 HTML 文件失败。",
  import_html_zip_failed: "导入 HTML 压缩包失败。",
  import_markdown_success: "成功导入 {count} 个 Markdown 文件。",
  import_markdown_failed: "导入 Markdown 文件失败。",
  import_markdown_zip_failed: "导入 Markdown 压缩包失败。",
  import_notion_html_failed: "导入 Notion HTML 失败。",
  import_notion_html_zip_success: "成功导入 {count} 个 Notion HTML 页面。",
  import_notion_html_zip_failed: "导入 Notion HTML 压缩包失败。",
  toggle_css_debug_menu: "切换 CSS 调试菜单",
  toggle_readonly: "切换只读模式",
  share_selection: "分享选择内容",
  switch_offset_mode: "切换偏移模式",
  toggle_outline_panel: "切换大纲面板",
  enable_outline_viewer: "启用大纲查看器",
  toggle_frame_panel: "切换框架面板",
  toggle_comment_panel: "切换评论面板",
  add_note: "添加便签",
  toggle_multiple_editors: "切换多编辑器",
  toggle_adapter_panel: "切换适配器面板",
  switch_editor: "切换编辑器",
  ...
  heading_6_desc: "六级标题。",
  bulleted_list: "无序列表",
  bulleted_list_desc: "创建无序列表。",
  numbered_list: "有序列表",
  numbered_list_desc: "创建有序列表。",
  todo_list: "待办列表",
  todo_list_desc: "创建待办列表。",
  code_block: "代码块",
  ...
  format_link: "链接",
  create_table: "创建表格",
  create_linked_doc: "创建链接文档",
  create_linked_doc_message: "为新文档输入标题。",
  linked_doc_created: "已创建链接文档",
  click_undo_to_recover_block_content: "可点击撤销恢复块内容。",
  copy: "复制",
  duplicate: "创建副本",
  ...
  downloading_file: "正在下载 {name}...",
  download_failed_file: "下载 {name} 失败！",
  upload_file_size_limit: "只能上传小于 {size} 的文件",
  open_this_doc: "打开此文档",
  inline_view: "行内视图",
  card_view: "卡片视图",
  embed_view: "嵌入视图",
  large_horizontal_style: "大水平样式",
  small_horizontal_style: "小水平样式",
  large_vertical_style: "大垂直样式",
  small_vertical_style: "小垂直样式",
  insert_to_page: "插入到页面",
  duplicate_as_note: "作为便签副本",
  duplicate_as_note_tooltip: "创建可编辑的副本作为便签，原始文档保持不变。",
  shadow: "阴影",
  border: "边框",
  corner_radius: "圆角",
  cutting_mode: "裁切模式",
  auto_height: "自动高度",
  customized_height: "自定义高度",
  note_style: "便签样式",
  custom_color: "自定义颜色",
  hidden_on_page: "页面中隐藏",
  no_shadow: "无阴影",
  box_shadow: "方形阴影",
  sticker_shadow: "贴纸阴影",
  paper_shadow: "纸张阴影",
  floating_shadow: "悬浮阴影",
  film_shadow: "胶片阴影",
  settings: "设置",
  equation: "公式",
  image_block: "图片块",
  ...
  toggle_list: "折叠列表",
  embed_link: "嵌入链接",
  embed_link_description: "支持 Google Drive、Spotify 等链接…",
  embed_link_placeholder: "粘贴嵌入链接…",
  empty: "空白",
  ...
  zoom_in: "放大",
  thickness: "粗细",
  input_url_placeholder: "输入 https://...",
  more_tools: "更多",
  hand_tool: "手形",
  select_tool: "选择",
  lasso_tool: "套索",
  ...
  switch_shape_type: "切换图形类型",
  shape_style: "样式",
  add_text: "添加文本",
  stroke_style: "线条样式",
  start_point_style: "起点样式",
  flip_direction: "翻转方向",
  end_point_style: "终点样式",
  connector_shape: "连接线形状",
  others: "其他",
  media: "媒体",
  add_media: "添加媒体",
  content_and_media: "内容与媒体",
  release_from_group: "解除分组",
  align_objects: "对齐对象",
  draw_connector: "绘制连接线",
  font: "字体",
  font_size: "字号",
  font_style: "字体样式",
  alignment: "对齐方式",
  ...
  edgeless_image: "图片",
  edgeless_link: "链接",
  edgeless_attachment: "附件",
  edgeless_file: "文件",
  mindmap: "思维导图",
  mindmap_import_support: "支持导入 FreeMind、OPML。",
  mindmap_import_failed_retry: "导入失败，请重试",
  lock: "锁定",
  click_to_unlock: "点击解锁",
  frame_section: "画框区域",
  group_section: "分组区域",
  bring_to_front: "移至顶层",
  bring_forward: "上移一层",
  send_backward: "下移一层",
  send_to_back: "移至底层",
  turn_into_linked_doc: "转换为链接文档",
  link_description: "新增链接将以卡片视图显示。",
  edgeless_text: "文本",
  edgeless_note: "便签",
  edgeless_frame: "画框",
  add_same_object: "添加相同对象",
  insert_into_page: "插入页面",
  ungroup: "取消分组",
  frame_inserted_into_doc: "画框已插入文档",
  group_inserted_into_doc: "分组已插入文档",
  frame_default_title: "画框 {number}",
  ...
  cancel: "取消",
  loading: "加载中...",
  failed_to_load_doc: "此链接文档加载失败。",
  doc_deleted: "此链接文档已被删除。",
  error: "错误",
  success: "成功",
  warning: "警告",
  info: "信息",
  ...
  activity_feed: {
    ...
    priority_set_to: "设置优先级为",
    state_set_to: "设置状态为",
    title_set_to: "设置标题为",
    parent_set_to: "设置父任务为",
    parent_removed: "移除了父任务",
    assignee_added: "添加了负责人",
    assignee_removed: "移除了负责人",
    relates_to_marked_prefix: "将",
    relates_to_marked_middle: "标记为关联到",
    relates_to_removed_prefix: "移除了与",
    relates_to_removed_suffix: "的关联",
    blocking_marked_prefix: "将",
    blocking_marked_middle: "标记为阻塞任务",
    blocking_removed_prefix: "移除了阻塞任务",
    blocked_by_marked_prefix: "将",
    blocked_by_marked_middle: "标记为被任务",
    blocked_by_marked_suffix: "阻塞",
    blocked_by_removed_prefix: "取消了",
    blocked_by_removed_middle: "被任务",
    blocked_by_removed_suffix: "阻塞",
    duplicate_marked_prefix: "将",
    duplicate_marked_middle: "标记为",
    duplicate_marked_suffix: "的重复任务",
    duplicate_removed_prefix: "取消了",
    duplicate_removed_middle: "与",
    duplicate_removed_suffix: "的重复标记",
    inbox_declined: "拒绝了收件箱任务",
    inbox_snoozed: "稍后处理了收件箱任务",
    inbox_accepted: "接受了收件箱任务",
    inbox_marked_duplicate: "通过标记重复任务拒绝了收件箱任务",
    inbox_updated: "更新了收件箱任务状态",
    this_work_item: "该任务",
    work_item: "任务",
    issue_deleted: "该任务已被删除",
    period: "。",
    start_date_set_to: "设置开始日期为",
    start_date_removed: "移除了开始日期",
    due_date_set_to: "设置截止日期为",
    due_date_removed: "移除了截止日期",
    issue_of_prefix: "（任务：",
    issue_for_prefix: "（任务：",
    issue_from_prefix: "（任务：",
    issue_suffix: "）",
  },
  labels: "标签",
  ...
  issue: {
    ...
    all: "所有任务",
    edit: "编辑任务",
    count_in_project: "本项目共有 {count} 个任务",
    count_in_cycle: "此周期共有 {count} 个任务",
    count_in_module: "此模块共有 {count} 个任务",
    count_in_project_archives: "项目归档中共有 {count} 个任务",
    title: {
      label: "任务标题",
      required: "任务标题为必填项",
    },
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        title: "项目、活动和指标概览",
        description:
          "欢迎使用 Plane，我们很高兴您能来到这里。创建您的第一个项目并跟踪您的任务，这个页面将转变为帮助您进展的空间。管理员还将看到帮助团队进展的项目。",
        primary_button: {
          text: "构建您的第一个项目",
          comic: {
    ...
    settings: {
      ...
      webhooks: {
        ...
        event_options: {
          projects: {
            label: "项目",
            description: "项目创建、更新或删除",
          },
          cycles: {
            label: "周期",
            description: "周期创建、更新或删除",
          },
          work_items: {
            label: "任务",
            description: "任务创建、更新、删除，或被加入周期/模块",
          },
          modules: {
            label: "模块",
            description: "模块创建、更新或删除",
          },
          work_item_comments: {
            label: "任务评论",
            description: "评论发布、更新或删除",
          },
        },
        toasts: {
          created: {
      ...
      projects: {
        empty_state: {
          image_alt: "暂无项目",
          title: "暂无项目",
          description: "项目是目标驱动工作的基础。你可以用它来管理团队、任务以及完成工作所需的一切。",
          learn_more: "了解更多关于项目",
          start_first_project: "创建你的第一个项目",
        },
      },
      api_tokens: {
        title: "API 令牌",
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        title: "尚无活动",
        description: "通过创建新任务开始！为其添加详细信息和属性。在 Plane 中探索更多内容以查看您的活动。",
      },
      assigned: {
        title: "没有分配给您的任务",
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        title: "自动归档已关闭的任务",
        description: "Plane 将自动归档已完成或已取消的任务。",
        duration: "自动归档已关闭",
      },
      "auto-close": {
        title: "自动关闭任务",
        description: "Plane 将自动关闭尚未完成或取消的任务。",
        duration: "自动关闭不活跃",
  ...
  project_issues: {
    empty_state: {
      no_issues: {
        ...
        description:
          "将任务视为待完成的工作。任务及其子任务通常是基于时间的、分配给团队成员的可执行项。您的团队通过创建、分配和完成任务来推动项目实现其目标。",
        primary_button: {
          text: "创建您的第一个任务",
          comic: {
            title: "任务是 Plane 中的基本构建块。",
            description: "重新设计 Plane 界面、重塑公司品牌或启动新的燃料喷射系统都是可能包含子任务的任务示例。",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        ...
        description:
          "页面是 Plane 中的思维记录空间。记录会议笔记，轻松格式化，嵌入任务，使用组件库进行布局，并将它们全部保存在项目上下文中。要快速完成任何文档，可以通过快捷键或点击按钮调用 Plane 的 AI Galileo。",
        primary_button: {
          text: "创建您的第一个页面",
        },
      },
  ...
  stickies: {
    ...
    placeholder: "点击此处输入",
    all: "所有便签",
    "no-data": "记下一个想法，捕捉一个灵感，或记录一个突发奇想。新建便签开始使用。",
    add: "新建便签",
    search_placeholder: "按标题搜索",
    delete: "删除便签",
    delete_confirmation: "您确定要删除此便签吗？",
    empty_state: {
      simple: "记下一个想法，捕捉一个灵感，或记录一个突发奇想。新建便签开始使用。",
      general: {
